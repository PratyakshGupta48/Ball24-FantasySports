...
function BallViewCompleted({name,userSetName,TeamCode1,TeamCode2,totalRuns,userSet,Points,PointsArray,Rank}) {
  ...
  <View style={{height:500}}>
    <View style={styles.BallViewMainContainer}>
      ...
      <View style={{flexDirection:'row',alignItems:'center',justifyContent:'space-between',width:'100%'}}>
        ...
        <Text style={[styles.BallViewNameText,{fontSize:14.5,borderBottomWidth:0.6,borderBottomColor:'#dedede',paddingHorizontal:10}]}>{'Points: '+Points+'  ,  Rank: '+(Rank?Rank:'—')}</Text>
